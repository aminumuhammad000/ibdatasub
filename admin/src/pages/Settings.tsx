          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-slate-500 mt-1">
                Manage general application configuration and contacts.
              </p>
            </div>
          </div>
            ...
            <div className="border-b border-slate-100 p-6 bg-slate-50/50 flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-slate-500">
                  Payment gateways and core email settings
                </p>
              </div>
            </div>
            <form
            ...
            >
              ...
              <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <label
                    className={`flex items-center p-4 border rounded-xl cursor-pointer transition-all ${systemSettings.payment_gateway === "vtstack" ? "border-blue-500 bg-blue-50 ring-1 ring-blue-500" : "border-slate-200 hover:bg-slate-50"}`}
                  >
                    <input
                      type="radio"
                    ...
                    <div className="ml-3">
                      ...
                      <span className="block text-xs text-slate-500">
                        Fast, secure, and reliable payments via PalmPay.
                      </span>
                    </div>
                  </label>

                  <label
                    className={`flex items-center p-4 border rounded-xl cursor-pointer transition-all ${systemSettings.payment_gateway === "payrant" ? "border-blue-500 bg-blue-50 ring-1 ring-blue-500" : "border-slate-200 hover:bg-slate-50"}`}
                  >
                    <input
                      type="radio"
                      name="payment_gateway"
                    ...
                    <div className="ml-3 flex-1">
                      ...
                      <span className="block text-xs text-slate-500">
                        Alternative payment provider with virtual account
                        support.
                      </span>
                    </div>
                  </label>
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden">
            <div className="border-b border-slate-100 p-6 bg-slate-50/50 flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-slate-500">
                  Contact details displayed to users in the app
                </p>
              </div>
            </div>
            <form
            ...
            >
              ...
              <div className="border-t border-slate-100 pt-6">
                <h3 className="text-sm font-bold text-slate-900 uppercase tracking-wider mb-4 text-indigo-600">
                  Social Media Links
                </h3>

...
export const config: Config = {
  ...
  topupmate: {
    ...
    baseUrl:
      process.env.TOPUPMATE_BASE_URL || "https://connect.topupmate.com/api",
  },
  ...
  fundingAccount: {
    ...
    accountName:
      process.env.FUNDING_ACCOUNT_NAME || "Topupmate connect/ Aminu(Topupmate)",
    accountNumber: process.env.FUNDING_ACCOUNT_NUMBER || "6600392859",
    instructions:
      process.env.FUNDING_INSTRUCTIONS ||
      "Transfer to this account and notify support with your reference.",
  },
};

...
const isSuccess1 = (mockResultWithError.status === 'success' || mockResultWithError.status === true);
const hasErrorMsg1 = mockResultWithError.msg || mockResultWithError.error;
...
const isSuccess2 = (mockResultSuccess.status === 'success' || mockResultSuccess.status === true);
const hasErrorMsg2 = mockResultSuccess.msg || mockResultSuccess.error;

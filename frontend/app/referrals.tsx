    ...
    const onShare = async () => {
        try {
            const result = await Share.share({
                message: `Join me on Marabusdata and earn ₦${settings?.referrer_bonus_amount || '...'} bonus! Use my referral code: ${stats?.referral_code}. Download Now: https://app.marabusdata.com.ng`,
            });
        } catch (error: any) {
                ...
                <View style={[styles.bannerCard, { backgroundColor: theme.primary }]}>
                    <View style={styles.bannerInfo}>
                        ...
                        <Text style={styles.bannerSubtitle}>
                            Invite your friends to Marabusdata and earn a bonus when they make their first transaction of ₦{settings?.min_transaction_for_bonus ?? '...'} or more.
                        </Text>
                    </View>
